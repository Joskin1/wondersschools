...
<head>
    ...
    <title>{{ $title ?? \App\Services\FrontendLibrary::getSetting('school_name', 'Wonders Kiddies Foundation Schools') }}</title>
...
<body class="font-sans antialiased text-gray-900 bg-white">
    <div class="flex flex-col min-h-screen">
        <!-- Navigation -->
        <nav x-data="{ open: false }" class="text-white sticky top-0 z-50 shadow-md" style="background-color: var(--color-tenant-primary);">
                    ...
                    <div class="flex-shrink-0 flex items-center">
                        <a href="{{ route('home') }}">
                            @if(\App\Services\FrontendLibrary::getSetting('school_logo'))
                                <img src="{{ Storage::url(\App\Services\FrontendLibrary::getSetting('school_logo')) }}" alt="{{ \App\Services\FrontendLibrary::getSetting('school_name', 'WKFS') }} Logo" class="h-12 w-auto">
                            @else
                                <span class="font-bold text-2xl tracking-wider">{{ \App\Services\FrontendLibrary::getSetting('school_name', 'WKFS') }}</span>
                            @endif
                        </a>
                    </div>
        ...
        <footer class="bg-gray-900 text-white pt-12 pb-8">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-500">
                    &copy; {{ date('Y') }} {{ \App\Services\FrontendLibrary::getSetting('school_name', 'Wonders Kiddies Foundation Schools') }}. All rights reserved.
                </div>
            </div>
        </footer>
    </div>
