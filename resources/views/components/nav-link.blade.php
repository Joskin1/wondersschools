...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-lime-green text-sm font-medium leading-5 text-white focus:outline-none focus:border-lime-green transition duration-150 ease-in-out'
