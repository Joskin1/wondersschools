...
<section id="home" class="relative min-h-[85vh] flex flex-col justify-between overflow-hidden bg-ink text-white">
  <!-- Full-bleed background photograph with left-to-right Ink gradient overlay -->
  <div class="absolute inset-0 z-0">
    <img src="{{ $image ?? 'https://placehold.co/1920x1080/0B2545/FAF8F4?text=Campus+Scholars' }}"
         alt="Campus"
