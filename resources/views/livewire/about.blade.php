<div>
    ...
    <div class="relative overflow-hidden py-20" style="background: linear-gradient(135deg, color-mix(in srgb, var(--color-tenant-primary) 8%, white), color-mix(in srgb, var(--color-tenant-primary) 3%, white));">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
            ...
            <p class="mt-4 text-xl font-medium text-tenant-primary">
                {{ \App\Services\FrontendLibrary::get('about_hero_subtitle', config('app.name', 'Wonders Kiddies Foundation Schools')) }}
            </p>
        </div>
    </div>
    ...
    <div class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Core Values -->
            <div class="mt-16">
                <h3 class="text-3xl font-extrabold text-center text-gray-900 mb-10">
