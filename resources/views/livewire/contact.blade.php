<div>
    ...
    <div class="relative overflow-hidden py-20" style="background: linear-gradient(135deg, color-mix(in srgb, var(--color-tenant-primary) 8%, white), color-mix(in srgb, var(--color-tenant-primary) 3%, white));">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
            <h1 class="text-4xl font-extrabold text-gray-900 sm:text-5xl lg:text-6xl">Contact Us</h1>
            <p class="mt-4 text-xl font-medium text-tenant-primary">We'd love to hear from you.</p>
        </div>
    </div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            <div class="flex-shrink-0">
                                <svg class="h-6 w-6 text-tenant-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="bg-gray-50 p-8 rounded-lg shadow-sm">
                    ...
                    <form wire:submit.prevent="submit" class="space-y-6">
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" wire:model="name" id="name" class="py-3 px-4 block w-full shadow-sm focus:ring-tenant-accent focus:border-tenant-accent border-gray-300 rounded-md">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="email" wire:model="email" id="email" class="py-3 px-4 block w-full shadow-sm focus:ring-tenant-accent focus:border-tenant-accent border-gray-300 rounded-md">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea wire:model="message" id="message" rows="4" class="py-3 px-4 block w-full shadow-sm focus:ring-tenant-accent focus:border-tenant-accent border-gray-300 rounded-md"></textarea>
                            </div>
