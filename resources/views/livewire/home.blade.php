    ...
    <div class="relative bg-dark-green text-white overflow-hidden" x-data="{
        ...
        <div class="absolute inset-0" x-show="images.length === 0">
            <img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"
                alt="School Campus" class="w-full h-full object-cover opacity-40">
            <div class="absolute inset-0 bg-gradient-to-r from-dark-green via-dark-green/80 to-transparent"></div>
        </div>

        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
            <div class="lg:w-2/3">
                <span class="block text-lime-green font-bold tracking-wide uppercase text-sm mb-2">Welcome to Wonders
                    Kiddies Foundation Schools</span>
                ...
                <p class="text-xl text-gray-200 mb-8 max-w-2xl leading-relaxed">
                    We don't just teach children; we cultivate thinkers, leaders, and compassionate citizens in a
                    secure, nurturing environment.
                </p>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('academics') }}"
                        class="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-bold rounded-md text-dark-green bg-lime-green hover:bg-opacity-90 transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                    ...
                    <a href="{{ route('contact') }}"
                        class="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-base font-bold rounded-md text-white hover:bg-white hover:text-dark-green transition duration-300">
                        Book a Tour
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center md:text-left">
                <div class="flex items-center justify-center md:justify-start space-x-2">
                    <svg class="w-6 h-6 text-dark-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Card 1 -->
                <div
                    class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 border-b-4 border-lime-green">
                    <div
                        class="w-14 h-14 bg-lime-green/20 rounded-full flex items-center justify-center mb-6 text-dark-green">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Our curriculum is designed to challenge and inspire. We focus on building a strong foundation in
                ...
                <!-- Card 2 -->
                <div
                    class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 border-b-4 border-light-blue">
                    <div
                        class="w-14 h-14 bg-light-blue/20 rounded-full flex items-center justify-center mb-6 text-light-blue">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        We nurture the whole child. From sports to arts, we provide opportunities for students to
                ...
                <!-- Card 3 -->
                <div
                    class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 border-b-4 border-brand-red">
                    <div
                        class="w-14 h-14 bg-brand-red/20 rounded-full flex items-center justify-center mb-6 text-brand-red">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        We instill strong moral values and a sense of community. Our students learn to be respectful,
    ...
    <div class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-end mb-12">
                ...
                <a href="{{ route('news') }}"
                    class="hidden md:inline-flex items-center font-bold text-dark-green hover:text-lime-green transition">
                    View All News <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    class="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 border border-gray-100">
                    <div class="relative h-48 overflow-hidden">
                        <img src="{{ Str::startsWith($post->image, 'http') ? $post->image : Storage::url($post->image) }}"
                            alt="{{ $post->title }}"
                            class="w-full h-full object-cover transform group-hover:scale-110 transition duration-500">
                        <div
                            class="absolute top-4 left-4 bg-lime-green text-dark-green text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide">
                            News
                        </div>
                    </div>
                    <div class="p-6">
                        ...
                        <a href="{{ route('post', $post) }}"
                            class="inline-flex items-center text-dark-green font-semibold hover:text-lime-green transition">
                            Read More <svg class="ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-8 text-center md:hidden">
                <a href="{{ route('news') }}"
                    class="inline-flex items-center font-bold text-dark-green hover:text-lime-green transition">
                    View All News <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                    </svg>
    ...
    <div class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300 flex flex-col items-center p-8 text-center">
                    <div class="w-32 h-32 rounded-full overflow-hidden mb-6 border-4 border-lime-green/30">
                        <img src="{{ Str::startsWith($staff->image, 'http') ? $staff->image : Storage::url($staff->image) }}"
                            alt="{{ $staff->name }}" class="w-full h-full object-cover">
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route('admissions') }}"
                    class="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-bold rounded-md text-dark-green bg-lime-green hover:bg-opacity-90 transition duration-300 shadow-lg">
                    Enrol Now
                </a>
                <a href="{{ route('contact') }}"
                    class="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-lg font-bold rounded-md text-white hover:bg-white hover:text-dark-green transition duration-300">
                    Book a Tour
                </a>
                <a href="https://wa.me/{{ str_replace(['+', ' '], '', \App\Models\Setting::where('key', 'school_phone')->value('value') ?? '') }}"
                    target="_blank"
                    class="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-bold rounded-md text-white bg-green-600 hover:bg-green-700 transition duration-300">
